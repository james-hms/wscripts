...
IF DEFINED ZORRO (
  C:\Apps\VSCodium\bin\codium --extensions-dir %USERPROFILE%\VSC\python\extensions --user-data-dir %USERPROFILE%\VSC\python\data
) ELSE (
  SET JAVA_HOME=
  W:\VSCode\bin\code --extensions-dir %USERPROFILE%\VSC\java\extensions --user-data-dir %USERPROFILE%\VSC\java\data
)
