...
set temporary_file=%USERPROFILE%\Favorites\Bookmarks\Bookmarks-chrome.%bkup_date%_%bkup_time%.json


echo // Chrome Bookmarks file (ascii text), has no file extension> %temporary_file%
echo //>> %temporary_file%
echo.>> %temporary_file%

type "%USERPROFILE%\AppData\Local\Google\Chrome\User Data\Default\Bookmarks" >> %temporary_file%
